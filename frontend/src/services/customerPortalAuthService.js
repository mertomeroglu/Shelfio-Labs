...
export const customerPortalAuthService = {
  ...
  createMobileOrder: (payload = {}) => request('/customer-auth/mobile-orders', { method: 'POST', body: JSON.stringify(payload) }),
  getMobileOrder: (id) => request(`/customer-auth/mobile-orders/${id}`),
  confirmMobileOrderHandoff: (id) => request(`/customer-auth/mobile-orders/${id}/confirm-handoff`, { method: 'POST' }),
