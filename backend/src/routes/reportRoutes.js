...
router.get('/pricing-analysis/price-actions/recent', requirePermission(PERMISSIONS.REPORT_VIEW), reportController.listRecentPriceActions);
router.post('/pricing-analysis/price-actions/temporary', requirePermission(PERMISSIONS.REPORT_VIEW), reportController.applyTemporaryPriceAction);
router.post('/pricing-analysis/price-actions/skip', requirePermission(PERMISSIONS.REPORT_VIEW), reportController.skipPricingDecision);
router.post('/pricing-analysis/price-actions/bulk-update', requirePermission(PERMISSIONS.REPORT_VIEW), reportController.applyBulkPriceUpdate);
router.post('/pricing-analysis/price-actions/:actionId/rollback', requirePermission(PERMISSIONS.REPORT_VIEW), reportController.rollbackPriceAction);
