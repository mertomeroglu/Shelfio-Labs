...
export const customerAuthService = {
  ...
  async createMobileOrder(id, payload) { return mobileOrderService.createFromCustomerCart(id, payload); },
  async getMobileOrder(id, orderId) { return mobileOrderService.getForCustomer(id, orderId); },
  async confirmMobileOrderHandoff(id, orderId) { return mobileOrderService.confirmCustomerHandoff(id, orderId); },
