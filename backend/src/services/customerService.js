...
const mapOrder = (x) => ({
  id: x.id,
  orderNo: x.orderNo || x.referenceNo || x.payload?.displayOrderNo || x.payload?.orderNo || x.id,
  displayOrderNo: x.orderNo || x.referenceNo || x.payload?.displayOrderNo || x.payload?.orderNo || '',
